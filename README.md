...
```bash
  bash -c "$(curl -L https://raw.githubusercontent.com/nPhenix-IT/Install-MikroTik-CHR-on-VPS/main/mik-6486.sh)"
```

For MikroTik 7.20.7

```bash
  bash -c "$(curl -L https://raw.githubusercontent.com/nPhenix-IT/Install-MikroTik-CHR-on-VPS/main/mik78.sh)"
```
